  ...
  return (
    ...
    <div className="w-full h-full max-w-4xl ml-[27%]  ">
      ...
      <div className="mb-10 font-[Gotu]">
        <h3 className="text-3xl  font-semibold mb-4 border-b pb-2"> Profile Information</h3>
        ...
        <button className="mt-4 bg-blue-600 text-white py-3.5 px-9 rounded-lg hover:bg-blue-700 transition">
            Save Changes
        </button>
      </div>
      <div className="mb-10 font-[Gotu] ">
